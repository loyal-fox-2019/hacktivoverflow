<template>
  <v-card class="mx-auto my-5 question-card" style="width: 90%" @click="toDetail">
    <v-sheet
      elevation="10"
    ...
    <v-list-item>
      ...
      <v-list-item-content>
        <v-list-item-title class="headline">How to make stackOverflow?</v-list-item-title>
        <v-list-item-subtitle>Kurt Wagner</v-list-item-subtitle>
      </v-list-item-content>
    </v-list-item>
